...
const CardProductOffered = () => {
  return (
    <Card className="card-product mx-auto card-offered">
      <Card.Body>
        <Row>
          <div className="d-inline-flex">
            <Col md={2}>
              <Image src="/1.png" alt="penjual1" className="seller_img rounded-3 me-2"></Image>
            </Col>
            <Col>
              <Row>
                <Col md={8}>
              ...
              <div className="mt-3 btn-product-offered d-flex">
