      ...
      <Container >
          <Row className="justify-content-md-center">
            ...
            <Carousel className="product-img">
                    <div>
                      <Image src={`http://localhost:8000/uploads/${products.product_photo}`}  alt="image1" className="product_img rounded-3"></Image>
                    </div>
                    <div>
                      <Image src={`http://localhost:8000/uploads/${products.product_photo}`} className="product_img rounded-3"></Image>
                    </div>
                    <div>
                      <Image src={`http://localhost:8000/uploads/${products.product_photo}`}  alt="image3" className="product_img rounded-3"></Image>
                    </div>
                </Carousel>
            </Col>
            <Col sm={4}>
            ...
            <Card.Body>
              ...
              <Card className="modal-card">
                <Card.Body>
                  <Row className="mt-0">
                    <Col md={3}>
                      <Image src={`http://localhost:8000/uploads/${products.product_photo}`} alt="...." className="seller_img rounded-3"></Image>
                    </Col>
                    <Col> 
